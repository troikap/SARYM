...
module.exports = {
    up: (queryInterface, Sequelize) => {
        return queryInterface.bulkInsert('pedidoestados', [
            { 
                "idPedidoEstado": 1, "idPedido": 1, "idEstadoPedido": 3, "descripcionPedidoEstado": "Normal", "fechaYHoraAltaPedidoEstado": currentDate, "fechaYHoraBajaPedidoEstado": null, "createdAt": currentDate, "updatedAt": currentDate
            },
            { 
