...
module.exports = {
    up: (queryInterface, Sequelize) => {
        return queryInterface.bulkInsert('usuarioestados', [
            {
                "idUsuarioEstado": 1, "idUsuario": 1, "idEstadoUsuario": 1, "descripcionUsuarioEstado": "", "fechaYHoraBajaUsuarioEstado": null, "fechaYHoraAltaUsuarioEstado": currentDate, "createdAt": currentDate, "updatedAt": currentDate
            }, 
            {
