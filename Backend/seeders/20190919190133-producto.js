...
module.exports = {
    up: (queryInterface, Sequelize) => {
        return queryInterface.bulkInsert('productos', [
            ...
            {"idProducto": 5,"idRubro": 10,"idUnidadMedida": 1, "cantidadMedida": 750, "codProducto": "TERRUÑC","nombreProducto": "Mi Terruño Chenín","descripcionProducto": "Uvas del valle de uco","pathImagenProducto": null,"createdAt": currentDate,"updatedAt": currentDate},
            ...
            {"idProducto": 10,"idRubro": 4,"idUnidadMedida": 4, "cantidadMedida": 8, "codProducto": "PIZZA","nombreProducto": "Pizza","descripcionProducto": "Pizza Mozzarella a la piedra 8 porciones.","pathImagenProducto": "../../assets/catalogo/productos/pizza.jpg","createdAt": currentDate,"updatedAt": currentDate},
