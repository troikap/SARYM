...
module.exports = {
    up: (queryInterface, Sequelize) => {
        return queryInterface.bulkInsert('comensals', [
            ...
            { 
                "idComensal": 2, "idUsuario": null, "idReserva": 1, "idEstadia": 1, "aliasComensal": "Otro Pepito", "edadComensal": 20, "createdAt": currentDate, "updatedAt": currentDate
            },
            { 
                "idComensal": 3, "idUsuario": 2, "idReserva": 2, "idEstadia": null, "aliasComensal": "Tercer Pepo", "edadComensal": 50, "createdAt": currentDate, "updatedAt": currentDate
            },
            { 
