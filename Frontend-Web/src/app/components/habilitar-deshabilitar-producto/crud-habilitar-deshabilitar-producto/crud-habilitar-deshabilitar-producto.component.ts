      ...
      this.productoServicio.getProducto(this.idProducto).then(res => {
        if (res["tipo"] == 2) {
          ...
          this.newForm = {
            ...
            nombreEstadoProducto: this.producto.productoestados[0]
              .estadoproducto.nombreEstadoProducto,
        ...
        aceptar: {
          ...
          action: function() {
            ...
            _this.productoServicio
              .habilitarDeshabilitarProducto(dtoCambioEstado)
              .then(response => {
                const titulo = "Éxito";
                const mensaje =
                      ...
                      action: function() {
                        _this.menuPromocionServicio
                          ...
                          .then(response => {
                            const titulo = "Éxito";
                            const mensaje =
                              "Se han actualizado los menu-promocion de forma exitosa";
