...
@Component({
  selector: 'app-backup-app',
  templateUrl: './backup-app.component.html',
  styleUrls: ['./backup-app.component.scss']
})
export class BackupAppComponent implements OnInit {

  public uploadedFiles = null;
  public backupGenerado = true;
  public backupCargado = true;
  
  info = `Usted podrá generar un Backup de toda la Aplicación.<br>Además, recuperar dicho Backup desde un archivo previamente generado.`
  accion = "Presione el siguiente botón para generar un archivo de Backup de la <strong>Aplicación</strong> del Sistema. El mismo puede demorar unos minutos en ser generado."
  info2 = "Presione el siguiente botón para restaurar una imagen de Backup de <strong>Aplicación</strong> del Sistema, previamente generada. La misma puede demorar unos minutos en ser cargada."
