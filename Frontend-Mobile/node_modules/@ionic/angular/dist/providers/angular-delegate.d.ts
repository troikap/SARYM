...
export declare function attachView(zone: NgZone, resolver: ComponentFactoryResolver, injector: Injector, location: ViewContainerRef | undefined, appRef: ApplicationRef, elRefMap: WeakMap<HTMLElement, any>, elEventsMap: WeakMap<HTMLElement, () => void>, container: any, component: any, params: any, cssClasses: string[] | undefined): any;
export declare function bindLifecycleEvents(zone: NgZone, instance: any, element: HTMLElement): () => void;
