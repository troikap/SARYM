...
const __chunk_10 = require('./chunk-87b2c2de.js');
    ...
    componentDidLoad() {
        __chunk_7.rIC(() => {
            ...
            if (__chunk_2.config.getBoolean('statusTap', isHybrid)) {
                new Promise(function (resolve) { resolve(require('./status-tap-9c8ba41f.js')); }).then(module => module.startStatusTap());
            }
...
class RouterOutlet {
    ...
    async componentDidLoad() {
        this.gesture = (await new Promise(function (resolve) { resolve(require('./swipe-back-8aa6eaed.js')); })).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart(), () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
